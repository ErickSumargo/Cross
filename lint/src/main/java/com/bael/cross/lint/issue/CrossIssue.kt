...
val ISSUE_PUBLIC_METHOD = create(
    ...
    explanation = "Public method(s) detected inside this class. See why and fix suggestion here (7): https://proandroiddev.com/personal-request-changes-materials-starter-pack-kotlin-ver-part-2-426084b9c9a1",
    category = USABILITY,
    priority = 10,
    severity = WARNING,
    implementation = Implementation(
...
val ISSUE_INIT_BLOCK = create(
    ...
    explanation = "init block detected inside this class. See why and fix suggestion here (9): https://proandroiddev.com/personal-request-changes-materials-starter-pack-kotlin-ver-part-2-426084b9c9a1",
    category = PERFORMANCE,
    priority = 10,
    severity = WARNING,
    implementation = Implementation(
